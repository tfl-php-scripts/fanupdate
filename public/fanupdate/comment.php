...
if ($showform) {
    ...
    <form action="comment.php" method="post">
        ...
        <div class="col1">
            <p><textarea id="comment" class="wysiwyg" name="comment" cols="80"
                         rows="18"><?php echo htmlspecialchars($cmt->getBody()); ?></textarea></p>
        </div>
            ...
            <fieldset id="action">
                ...
                <div class="secondary">
                    <input type="submit" name="action" value="delete" class="delete"
                           title="Delete this comment, accesskey x" accesskey="x"/>
                </div>
            </fieldset>
        </div>
