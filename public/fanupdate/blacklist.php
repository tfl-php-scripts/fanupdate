...
<input type="submit" id="action" name="action" value="add" class="add" title="blacklist this word, accesskey s" accesskey="s" /></p>
</form>
...
while ($clean = $fu->db->ReadRecord()) {
    ...
    <td><input type="checkbox" id="badword<?php echo $i; ?>" name="badword[<?php echo $i; ?>]" value="<?php echo $clean['badword']; ?>" /></td>
    </tr>
    <?php
...
<tr>
<td>&nbsp;</td>
<td><input type="submit" name="action" value="delete" class="delete" title="Delete checked words from the blacklist" /></td>
</tr>
</tfoot>
